...
| 2 | **Riser Length** | `kParamRiserLength` | Continuous knob | 0.25 – 16 | 0.25 | 4 | beats | Duration of the riser before the hit. Snaps to musical subdivisions (1/4, 1/2, 1, 2, 4, 8, 16). Display value should show musical notation where possible (e.g., "4 beats", "1/2 beat"). |
