...
constexpr int kPreviewTriggerMidiNote = 60;   ///< UI preview transport triggers middle C
constexpr int kPreviewTriggerVelocity = 100;  ///< UI preview transport uses a fixed audition velocity
