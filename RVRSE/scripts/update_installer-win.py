...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RVRSE Demo Installer\n"
      else:
        line="OutputBaseFilename=RVRSE Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RVRSE Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RVRSE installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RVRSE Demo installer\n"
     else:
       line="SetupWindowTitle=RVRSE installer\n"
